<aside class="flex flex-col text-gray-800 bg-white shadow-sm transition-all duration-300 ease-in-out flex-shrink-0" :class="isSidebarExpanded ? 'w-64' : 'w-20'">
  <a href="#" class="h-20 flex items-center px-4 bg-gradient-to-r from-cyan-700 to-blue-700 hover:text-gray-900 hover:opacity-90 focus:outline-none focus:text-gray-900 focus:bg-gray-200 overflow-hidden">
